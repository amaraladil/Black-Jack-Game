/** GROUP_3_FINAL_PROJECT_DECK.h
 *	@author		Thom MacDonald
 *	@MODIFIED BY: Amar Al-Adil, Tyler Nankishore, Yuan Gao (Peter)
 *	@version	2014.02
 *	@date:		December 9, 2016
 *  @description:	Create a header class that sets up the ranks and suits of classic cards for the Final Project
*/
...
class StandardPlayingCard // Class declaration section
{
	public:	
		...
		int getRank() const { return myRank;} //Gets the rank's number
